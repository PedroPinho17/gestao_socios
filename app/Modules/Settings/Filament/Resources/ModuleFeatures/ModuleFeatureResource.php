...
namespace App\Modules\Settings\Filament\Resources\ModuleFeatures;

use App\Models\Module;
use App\Models\ModuleFeature;
use App\Modules\Settings\Filament\Resources\ModuleFeatures\Pages\CreateModuleFeature;
use App\Modules\Settings\Filament\Resources\ModuleFeatures\Pages\EditModuleFeature;
use App\Modules\Settings\Filament\Resources\ModuleFeatures\Pages\ListModuleFeatures;
        ...
        return $table
            ->columns([
                ...
                ToggleColumn::make('enabled')
                    ...
                    ->tooltip(fn (ModuleFeature $record): ?string => $record->is_core
                        ? 'Funcionalidade core — não pode ser desactivada.'
                        : (! $record->module?->isEnabled()
                            ? 'Sem efeito enquanto o módulo pai estiver desactivado.'
                            : null)),
