...
Route::middleware(['auth'])->group(function () {
    Route::middleware('module:'.ModuleRegistry::CARTOES)->group(function () {
    ...
    Route::middleware('module:'.ModuleRegistry::RELATORIOS)->group(function () {
    ...
    Route::middleware('module:'.ModuleRegistry::COMPROVATIVOS)->group(function () {
